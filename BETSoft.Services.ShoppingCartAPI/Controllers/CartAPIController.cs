...
using BETSoft.Services.ShoppingCartAPI.Messages;
using BETSoft.Services.ShoppingCartAPI.Models.Dto;
using BETSoft.Services.ShoppingCartAPI.RabbitMQSender;
using BETSoft.Services.ShoppingCartAPI.Repository;
...
namespace BETSoft.Services.ShoppingCartAPI.Controllers
{
    [ApiController]
    [Route("api/cart")]
